 ...
 */
  ...
  function isPalindrome(str) {
    ...
    // chained methods.
    // split the string into an array where each index is a different character
    // reverse that array
    // rejoining that array into a string.
  ...
  */
  ...
  function longestPalindromicSubstring(str) {
    ...
    for (let i = 0; i < palindromeArray.length;i++){
      if (palindromeArray[i].length > palindromeLongest.length){
